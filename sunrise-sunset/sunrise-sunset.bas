 ...
 130 GOSUB 3000
 140 PRINT 
 145 IF ZXP=1 THEN LPRINT 
 150 PRINT "--------------------------------"
 152 IF ZXP=1 THEN LPRINT "--------------------------------"
 155 PRINT "DATE         SUNRISE SUNSET"
 157 IF ZXP=1 THEN LPRINT "DATE         SUNRISE SUNSET"
 160 FOR I=1 TO 7
 170 PRINT 
 175 IF ZXP=1 THEN LPRINT 
 180 GOSUB 4000
 190 PRINT "  ";
 195 IF ZXP=1 THEN LPRINT "  ";
 200 GOSUB 5000
 210 GOSUB 2000
 220 NEXT I
 230 PRINT 
 235 IF ZXP=1 THEN LPRINT 
 240 PRINT "--------------------------------"
 245 IF ZXP=1 THEN LPRINT "--------------------------------"
 250 STOP 
...
4020 GOSUB 7100
4030 PRINT "/";
4035 IF ZXP=1 THEN LPRINT "/";
4040 LET T=M
4050 GOSUB 7100
4060 PRINT "/";
4065 IF ZXP=1 THEN LPRINT "/";
4070 LET T=Y
4080 GOSUB 7000
4090 RETURN 
...
5080 PRINT " ";
5085 IF ZXP=1 THEN LPRINT " ";
5090 IF ABS (SC)<=1 THEN GOSUB 5130
5100 IF SC>1 THEN PRINT "SUN UP ALL DAY"
5105 IF SC>1 AND ZXP=1 THEN LPRINT "SUN UP ALL DAY"
5110 IF SC<-1 THEN PRINT "SUN DOWN ALL DAY"
5115 IF SC<-1 AND ZXP=1 THEN LPRINT "SUN DOWN ALL DAY"
5120 GOTO 5350
...
5210 GOSUB 7100
5220 PRINT ":";
5225 IF ZXP=1 THEN LPRINT ":";
5230 LET T=MR
5240 GOSUB 7100
5250 PRINT "   ";
5255 IF ZXP=1 THEN LPRINT "   ";
5260 LET T=HS
5270 GOSUB 7100
5280 PRINT ":";
5285 IF ZXP=1 THEN LPRINT ":";
5290 LET T=MS
5300 GOSUB 7100
5350 RETURN 
7000 REM PRINT FOUR-DIGIT NUMBER
7010 IF T<1000 THEN PRINT "0";
7015 IF T<1000 AND ZXP=1 THEN LPRINT "0";
7020 IF T<100 THEN PRINT "0";
7025 IF T<100 AND ZXP=1 THEN LPRINT "0";
7100 REM PRINT TWO-DIGIT NUMBER
7110 IF T<10 THEN PRINT "0";
7115 IF T<10 AND ZXP=1 THEN LPRINT "0";
7120 PRINT T;
7125 LPRINT T;
7130 RETURN 
8000 REM GET INPUTS
...
8020 INPUT B5
8030 PRINT B5
8032 IF ZXP=1 THEN LPRINT "LATITUDE (DEG) ";B5
8035 LET B5=DR*B5
8040 PRINT "ENTER LONGDITUDE (DEG) ";
8050 INPUT L5
8060 PRINT L5
8065 IF ZXP=1 THEN LPRINT "LONGDITUDE (DEG) ";L5
8070 PRINT "ENTER TIMEZONE (HRS) ";
8080 INPUT H
8090 PRINT H
8095 IF ZXP=1 THEN LPRINT "TIMEZONE (HRS) ";H
